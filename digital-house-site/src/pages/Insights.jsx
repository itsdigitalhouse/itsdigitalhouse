  ...
  return (
    <div className="w-full min-h-screen bg-white">
      <Helmet>
        ...
        <meta name="description" content="Stay updated with the latest trends, guides, and expert insights on tech, design, and marketing." />
        ...
        <meta property="og:description" content="Stay updated with the latest trends, guides, and expert insights on tech, design, and marketing." />
        ...
        <meta name="twitter:description" content="Stay updated with the latest trends, guides, and expert insights on tech, design, and marketing." />
