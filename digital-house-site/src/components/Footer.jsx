...
import { FaFacebookF, FaInstagram, FaLinkedinIn, FaPinterestP, FaTiktok } from 'react-icons/fa';
...
const Footer = () => {
  ...
  return (
    <footer className="relative bg-[#0a0a0a] text-white w-full h-full overflow-hidden flex flex-col items-center justify-center border-t border-white/5">
      ...
      >
        ...
        <motion.div
          variants={itemVariants}
          className="flex justify-center flex-wrap gap-3 sm:gap-5 md:gap-8 mb-10 sm:mb-14 lg:mb-16"
        >
