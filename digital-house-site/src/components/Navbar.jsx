...
const duckQuotes = [
  { question: "Why don't web developers go out in the rain?", answer: "\"Because they are afraid their bugs might get wet!\"" },
  { question: "Why did the computer wear glasses?", answer: "\"Because its eyes (i's) were getting weak!\"" },
  { question: "What does a developer do after eating pizza?", answer: "\"Optimizes the slice!\"" },
  { question: "What is it like to learn programming?", answer: "\"It’s exactly like drinking 10 cups of coffee in one breath!\"" },
  { question: "What is the difference between a database and a ghost?", answer: "\"Ghosts can't be seen, and databases sometimes refuse to commit!\"" },
  { question: "Why does a UI designer get angry?", answer: "\"Because there is absolutely no alignment in their life!\"" },
  { question: "When the client asks, When will the website be complete?", answer: "\"The developer replies: Right after deployment just one more bug to fix!\"" },
  { question: "How many friends does Internet Explorer have?", answer: "\"Zero, because it is the slowest of them all!\"" },
];
