...
import luxuryEcommerceImg from '../assets/luxurysofa.jpg';
import logisticsPortalImg from '../assets/logisticsandminerals.jpg';
...
import mineralsandmetalsImg from '../assets/minderalsandmetal.jpg';
...
const CorePillars = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      mockupImage: luxuryEcommerceImg,
    ...
    },
    {
      ...
      mockupImage: logisticsPortalImg,
    ...
    },
    {
      ...
      mockupImage: mineralsandmetalsImg,
    ...
    <section className="w-full bg-[#F4F6F8] px-0 py-12 md:py-20 flex flex-col items-center overflow-hidden select-none font-sans relative">
      ...
      <style>{`
        ...
        .core-pillars-word-marquee {
          animation: corePillarsWordMarquee 6s linear infinite;
