...
import teamconceptImg from '../assets/teamconcept.jpg';
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="border-l-4 pl-4" style={{ borderColor: '#75b0d2' }}>
                ...
                <p className="text-xs sm:text-sm text-gray-500 font-medium leading-relaxed">Crafting high-converting UX layouts, compliance-ready enterprise architectures, and premium brand positionings tailored for the British consumer base.</p>
              </div>
              <div className="border-l-4 pl-4" style={{ borderColor: '#7361a7' }}>
                ...
                <p className="text-xs sm:text-sm text-gray-500 font-medium leading-relaxed">Architecting multi-lingual enterprise software layouts and hyper-scale growth modules to catalyze regional digital transformation initiatives.</p>
              </div>
            </div>
          </motion.div>
