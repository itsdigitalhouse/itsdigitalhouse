...
const ModernHero = () => {
  ...
  return (
    ...
    >
      ...
      <div style={{ position: 'absolute', left: isMobile ? '10px' : '200px', top: '120px', zIndex: 20, color: 'white', textAlign: 'left' }}>
      ...
      <div ref={textWrapRef} style={{ zIndex: 20, width: '100%', textAlign: 'center', perspective: '1000px', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        <span style={{ display: 'block', fontSize: isMobile ? '40px' : '100px', fontWeight: 900, color: 'transparent', WebkitTextStroke: '1px #ffffff', transition: '0.4s', marginLeft: isMobile ? '0' : '300px', transform: straighten ? 'rotateY(0deg)' : 'rotateY(40deg)' }}>IDEAS MADE</span>
        
        <span style={{ 
          display: 'block', 
          fontSize: isMobile ? '60px' : '170px', 
          fontWeight: 900, 
